...
*(Qing Wang, Yihui Zhao, Yingpu Che, Han Shen, Yongbin Qiu, Yixiang Wang. [International Journal of Applied Earth Observation and Geoinformation] [2025])*  
  ...
  We pioneer a semi-supervised learning (SSL) framework that synergistically integrates unsupervised pseudo-label generation, Mask R-CNN-based instance segmentation, and innovative staged fine-tuning strategy. 
